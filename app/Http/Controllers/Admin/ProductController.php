...
class ProductController extends Controller
{
    ...
    public function edit($product)
    {
	    ...
	    $categories = \App\Models\Category::all(['id', 'name']);
      $preco = str_replace ('.',',',$product['price']);
      //$preco = formatPriceToDatabase($product['price']);

	    return view('admin.products.edit', compact('product', 'categories', 'preco'));
    }

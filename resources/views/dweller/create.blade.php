    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('dweller.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="street" id="street" class="form-control @error('street') is-invalid @enderror">
                                    ...
                                    @foreach($userStreet as $key => $end)
                                    <option value="{{$end->name}}" @if (old('street') == $end->name) selected @endif> {{$end->name}}</option> 
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="other_number" type="text" class="form-control @error('other_number') is-invalid @enderror" name="other_number" value="{{old('other_number')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lot" type="text" class="form-control @error('lot') is-invalid @enderror" name="lot" value="{{old('lot')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @foreach($userSituation as $key => $end)
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input id="status" type="radio" class="form-check-input @error('status') is-invalid @enderror" name="status" value="{{$end->id}}"><div style="background: {{$end->color}};width:10px;height:10px;display:inline-block"></div> {{$end->name}} <br>
                                    </label>
                                </div>
                                @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" value="{{old('phone')}}" name="phone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile_phone" type="text" class="form-control @error('mobile_phone') is-invalid @enderror" value="{{old('mobile_phone')}}" name="mobile_phone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="obs" name="obs" rows="4" cols="50" class="form-control @error('obs') is-invalid @enderror">{{old('obs')}}</textarea>
